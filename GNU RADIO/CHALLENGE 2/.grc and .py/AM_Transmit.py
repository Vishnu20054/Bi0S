...
class AM_Transmit(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "AM_Transmit", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AM_Transmit")
        ...
        # Blocks
        ##################################################
        self._volume_range = Range(0, 10.0, 0.1, 1.2, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(48000, analog.GR_COS_WAVE, 1000, 0.5, 0, 0)

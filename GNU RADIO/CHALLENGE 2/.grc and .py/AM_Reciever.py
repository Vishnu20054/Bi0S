...
class AM_Reciever(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "AM_Reciever", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AM_Reciever")
        ...
        self.settings = Qt.QSettings("GNU Radio", "AM_Reciever")
        ...
        # Blocks
        ##################################################
        self._volume_range = Range(0, 1.0, 0.05, 0.3, 200)
...
def main(top_block_cls=AM_Reciever, options=None):
